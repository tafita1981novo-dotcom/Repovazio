    ...
    <div className="app">
      ...
      <main className="main">
        ...
        <div className="ia">
          ...
          <div className="in">Daniela V19 🎤📄 · Groq{useQwen?' + Qwen3':''} · Giphy · Browser · Skills · MCP · 24/7</div>
        </div>
      </main>
